...
Matches the device tiers in the founder's original spec (Desktop, Laptop, Tablet, Large Mobile) plus the explicit lockout tier, with an added top tier since this is a cinematic, scroll-driven experience that should be designed deliberately for large displays, not just capped at "desktop." The lockout threshold was lowered from <390px to <320px on 2026-07-16 (founder decision, PRD §7): 320px is the WCAG 1.4.10 reflow width, and iPhone SE/Mini (375px) and compact Androids (360px) now receive the full site.

| Token           | Range           | Treatment                                                                                                                                                                                                                       |
| --------------- | --------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `bp-blocked`    | < 320px         | Full-screen premium lockout message (per PRD §7) — no layout attempted                                                                                                                                                          |
| `bp-mobile-lg`  | 320px – 767px   | Single-column, chapters stack vertically, motion reduced to opacity/slide only (no parallax/3D)                                                                                                                                 |
